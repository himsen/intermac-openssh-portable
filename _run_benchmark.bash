...
SSH=$(pwd)/ssh
# 100mb
FNAME_SCP_SIZE=104857600
FNAME_SCP='scp_copy'
DATE=`date +%Y-%m-%d:%H:%M:%S`

GREP_SCP='Wall time\|Bytes encrypted sent\|Bytes raw sent'
...
rm_remote_data () {
	...
	$SSH -i $ID_FILE -p $PORT $USER@$DEST "rm $FNAME_SCP"
...
do
	...
	FNAME_NEW_LOG="imopenssh_${AUTH_CIPHER_SUITES[i]}"
	mv $FNAME_LOG_PREFIX $FNAME_NEW_LOG
done
